...
var requestCtrlStub = {
  ...
  upsert: 'requestCtrl.upsert',
  patch: 'requestCtrl.patch',
...
describe('Request API Router:', function() {
  ...
  describe('PUT /api/requests/:id', function() {
    it('should route to request.controller.upsert', function() {
      expect(routerStub.put
        .withArgs('/:id', 'requestCtrl.upsert')
        ).to.have.been.calledOnce;
    });
  });

  describe('PATCH /api/requests/:id', function() {
    it('should route to request.controller.patch', function() {
      expect(routerStub.patch
        .withArgs('/:id', 'requestCtrl.patch')
        ).to.have.been.calledOnce;
    });
  });
